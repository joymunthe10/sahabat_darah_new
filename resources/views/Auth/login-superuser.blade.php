...
<head>
    ...
    <title>Sahabat Darah - Super User Login</title>
    ...
    <div class="container">
        ...
        <div class="right-side">
            ...
            <div class="login-buttons">
                <form method="POST" action="{{ route('login.superuser') }}">
                    @csrf
                    <h2 style="text-align: center; margin-bottom: 20px; font-size: 24px; color: #333;">Super User Login</h2>
