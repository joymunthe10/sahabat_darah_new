...
<head>
    ...
    <title>Sahabat Darah - Hospital Admin Login</title>
    ...
    <div class="container">
        ...
        <div class="right-side">
            ...
            <div class="login-buttons">
                <form method="POST" action="{{ route('login.rs') }}" autocomplete="off">
                    @csrf
                    <h2 style="text-align: center; margin-bottom: 20px; font-size: 24px; color: #333;">Hospital Admin Login</h2>
                    ...
                    <input type="hidden" name="role" value="rs">
